...
function loaditemsdetails() {
    ...
    let dbRef = ref(db, `workshop/main/`+ itemKey);
    ...
    get(dbRef).then((snapshot) => {
        ...
        if (dataCache) {
            ...
            document.getElementById('section').textContent = dataCache.sec || 'N/A';
            document.getElementById('partno').textContent = dataCache.part_no || 'N/A';
            document.getElementById('lp').textContent = dataCache.lp || 'N/A';
        } else {
...
function returnItemToStore(recordKey) {
    ...
    path = `workshop/${itemKey}/history/${recordKey}`;
...
function markAsServicable(recordKey) {
    ...
    const path = `workshop/${itemKey}/unsvc/${recordKey}`;
...
function printItemDetails() {
    ...
    const section = document.getElementById('section').textContent || 'N/A';
    const partno = document.getElementById('partno').textContent || 'N/A';
    const lp = document.getElementById('lp').textContent || 'N/A';
        ...
        <body>
            ...
            <div class="item-summary">
                ...
                <div class="summary-grid">
                    ...
                    <div class="summary-item">
                        <span class="summary-label">Part No:</span>
                        <span class="summary-value">${partno}</span>
                    </div>
                    <div class="summary-item">
                        <span class="summary-label">LP:</span>
                        <span class="summary-value">${lp}</span>
                    </div>
                    <div class="summary-item">
